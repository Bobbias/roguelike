...
def play_game(player, entities, game_map, message_log, game_state, con, panel, constants):
    ...
    while not tcod.console_is_window_closed():
        ...
        if show_character_screen:
            previous_game_state = game_state
            game_state = GameStates.PLAYER_SCREEN
        ...
        if exit_game:
            if game_state in (GameStates.SHOW_INVENTORY, GameStates.DROP_INVENTORY, GameStates.PLAYER_SCREEN):
                game_state = previous_game_state
        ...
        for player_turn_result in player_turn_results:
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(Message(
                        'Your battle skills grow stronger! You reached level {}!'.format(player.level.current_level), tcod.yellow))
                    previous_game_state = game_state
