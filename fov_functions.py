...
def recompute_fov(fov_map, player_x, player_y, radius, light_walls=True, algorithm=0):
    tcod.map_compute_fov(fov_map, player_x, player_y, radius, light_walls, algorithm)
